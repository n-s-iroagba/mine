...
MiningSubscription_1.default.hasMany(Transaction_1.default, {
    foreignKey: 'entityId',
    constraints: false,
    scope: {
        entity: 'subscription',
...
Transaction_1.default.belongsTo(MiningSubscription_1.default, {
    foreignKey: 'entityId',
    constraints: false,
    as: 'subscription',
});
MiningSubscription_1.default.belongsTo(Miner_1.default, {
    foreignKey: 'minerId',
    as: 'miner',
});
