...
class KYCFeeService extends utils_1.BaseService {
    ...
    async createKYCFee(feeData) {
        try {
            ...
            if (existingFee) {
                throw new utils_1.ValidationError('KYC fee already exists for this miner');
            }
    ...
    async getKYCFeeByMinerId(minerId) {
        try {
    ...
    async markFeeAsPaid(id) {
        try {
            ...
            if (kycFee.isPaid) {
                throw new utils_1.ValidationError('KYC fee is already paid');
            }
            const updatedFee = await this.kycFeeRepository.markAsPaid(id);
            if (!updatedFee) {
                throw new utils_1.AppError('Failed to mark KYC fee as paid');
            }
...
exports.KYCFeeService = KYCFeeService;
